(* ::Package:: *)
(* EPS.wl — EPS axioms on finite directed graphs *)
(* Implements message and echo functions following Ehlers-Pirani-Schild *)
(* Requires: LightRays.wl (for OutgoingLightRays, IncomingLightRays) *)
(* Load with: Get["Code/EPS.wl"] *)
